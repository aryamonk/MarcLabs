            ...
            <tr>    <td colspan="2" align="center"><jsp:include page="menu.jsp" /><hr color="blue"></td>  </tr>
                    ...
                    <tr>    <td colspan="2" align="center">
                            ...
                            <%
                                    ...
                                    int rid=Integer.parseInt(request.getParameter("txt_uid"));
                                    

                                    PreparedStatement ps=cn.prepareStatement("select response from byrequirement where rid=?");
                                    ps.setInt(1, rid);
                                    ResultSet rs=ps.executeQuery();
                                    rs.next();
                                    String _response=rs.getString(1);
                            ...
                            <form method="post" action="TrackResponse.jsp">
                                ...
                                <table cellpadding="10" cellspacing="0" border="0" width="70%">
                                    ...
                                    <tr>    <td colspan="4" align="center"><input type="submit" value="Track The Response"></td>    </tr>
                    ...
                    <marquee><font face="verdana" color="green" size="3"><%=_response%></font></marquee>
