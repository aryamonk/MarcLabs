            ...
            <tr>    <td colspan="2" align="center"><jsp:include page="menu.jsp" /><hr color="blue"></td>  </tr>
                    ...
                    <tr>    <td colspan="2" align="center">
                            ...
                            <%!
                                ...
                                String[] questions={"What is your pet name?","Name of your first movie?"};
                            %>
                            
                            <form method="post" action="SignupconfirmAdmin.jsp">
                                
                                <table cellpadding="5" cellspacing="0" border="0" width="70%">
                                    
                                    
                                    <tr bgcolor="blue"><th colspan="4"><font face="verdana" size="3" color="white">NEW ADMIN SIGNUP</font></th></tr>
                                    ...
                                    <tr>    <td width="20%"></td><td><font face="verdana" size="3">Enter Name</font></td><td><input type="text" name="txt_name" style="width: 350px"></td><td width="20%"></td>    </tr>
                                     ...
                                     <tr>    <td width="20%"></td><td><font face="verdana" size="3">Phone number</font></td><td><input type="text" name="txt_mobile" style="width: 350px"></td><td width="20%"></td>    </tr>
                                     <tr>    <td width="20%"></td><td><font face="verdana" size="3">Email</font></td><td><input type="email" name="txt_email" style="width: 350px"></td><td width="20%"></td>    </tr>
                                             ...
                                             <tr>    <td width="20%"></td><td><font face="verdana" size="3">Answer</font></td><td><input type="text" name="txt_ans" style="width: 350px"></td><td width="20%"></td>    </tr>
                                             
                                             <tr>    <td width="20%"></td><td><font face="verdana" size="3">Gender</font></td><td><input type="radio" name="rdb_gender" value="Male">Male &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="rdb_gender" value="Female">Female</td><td width="20%"></td>    </tr>
                                    
                                    
                                             <tr>    <td width="20%"></td><td><font face="verdana" size="3">Password</font></td><td><input type="password" name="txt_pass" style="width: 350px"></td><td width="20%"></td>    </tr>
